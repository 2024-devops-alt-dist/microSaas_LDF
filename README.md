...
Create a file named .env in the root of your project and define the necessary environment variables for the database connection and any other configuration. Dont forget to also creat a .env.production on the api repository with the same structure as the .env.example. You can use the .env.example file as a reference.
